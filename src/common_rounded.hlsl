...
// feature toggles - default to ON so shaders that include this file
// without defines (blur, shadows) keep full functionality
#ifndef FEATURE_POW
#define FEATURE_POW 1
#endif
#ifndef FEATURE_ARC
#define FEATURE_ARC 1
#endif
#ifndef FEATURE_OUTLINE
#define FEATURE_OUTLINE 1
#endif
...
#else
// power 2 = plain euclidean length, no pow() at all
float length_custom(float2 vec)
{
    return length(vec);
}
